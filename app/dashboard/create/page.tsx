...
export default function CreateNews() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(err instanceof Error ? err.message : "Failed to publish news");
    } finally {
      setLoading(false);
    }
  };
              ...
              <div className="space-y-6">
                    ...
                    <div className="relative w-full aspect-video">
                      {!preview ? (
                        <label className="flex flex-col items-center justify-center w-full h-full border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                          ...
                          <p className="text-xs text-gray-500 text-center px-2">Click to upload featured image</p>
                          <input
                            type="file"
                            className="hidden"
                            accept="image/*"
                ...
                <div className="flex space-x-3 mt-4">
                  ...
                  >
                    ...
                    <span>{loading ? "Publishing..." : "Publish News Post"}</span>
                  </button>
                </div>
              </div>
            </div>
